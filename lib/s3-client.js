...
module.exports = {
  async objectExists(objectKey) {
    console.time('Checking bucket for existing image with key ' + objectKey);
    ...
    try {
      ...
      console.timeEnd('Checking bucket for existing image with key ' + objectKey);
    }
  ...
  async putBase64EncodedImage(objectKey, base64EncodedImage, type = 'png') {
    console.time('Uploading object to S3');
    ...
    try {
      ...
      console.timeEnd('Uploading object to S3');
  ...
  async getObject(objectKey) {
    console.time('Retrieveing object from S3');
    ...
    try {
      ...
      console.timeEnd('Retrieveing object from S3');
